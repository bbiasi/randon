...
# APESAR DOS EXCELENTES VALORES DE PERFORMACE, VALE A RESSALVA DA NECESSIDADE DE
# TRANSFORMACAO DE VOLTA (BACK TRANSFORMAITON), DADO A TRANSFORMACAO INICIAL 
# REALIZADA PARA A VARIÁVEL PRECO.
...
# TENDENCIA, VIES. A REDUCAO DO RMSE PODE SER FEITA ATRAVES DE SELECAO DE 
...
# "VB" PODE SER IDEALIZADO COMO ETAPA DE PLANEJAMENTO FINANCEIRO PARA AS
# CORRETORAS.
